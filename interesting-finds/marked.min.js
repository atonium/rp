 ...
 */
 !(function (e) {
        ...
        (a.prototype.token = function (e, t) {
            ...
            for (e = e.replace(/^ +$/gm, ""); e; )
                if (((s = this.rules.newline.exec(e)) && ((e = e.substring(s[0].length)), 1 < s[0].length && this.tokens.push({ type: "space" })), (s = this.rules.code.exec(e)))) {
                    ...
                    (o = { type: "table", header: y(s[1].replace(/^ *| *\| *$/g, "")), align: s[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: s[3] ? s[3].replace(/\n$/, "").split("\n") : [] }).header.length === o.align.length
                ) {
                    ...
                    (e = e.substring(s[0].length)), this.tokens.push({ type: "blockquote_start" }), (s = s[0].replace(/^ *> ?/gm, "")), this.token(s, t), this.tokens.push({ type: "blockquote_end" });
                else if ((s = this.rules.list.exec(e))) {
                    for (
                        e = e.substring(s[0].length), a = { type: "list_start", ordered: (d = 1 < (i = s[2]).length), start: d ? +i : "", loose: !1 }, this.tokens.push(a), n = !(h = []), f = (s = s[0].match(this.rules.item)).length, c = 0;
                        c < f;
                        c++
                    )
                        (u = (o = s[c]).length),
                            ~(o = o.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && ((u -= o.length), (o = this.options.pedantic ? o.replace(/^ {1,4}/gm, "") : o.replace(new RegExp("^ {1," + u + "}", "gm"), ""))),
                            c !== f - 1 && ((l = x.bullet.exec(s[c + 1])[0]), (1 < i.length ? 1 === l.length : 1 < l.length || (this.options.smartLists && l !== i)) && ((e = s.slice(c + 1).join("\n") + e), (c = f - 1))),
                            (r = n || /\n\n(?!\s*$)/.test(o)),
                            c !== f - 1 && ((n = "\n" === o.charAt(o.length - 1)), r || (r = n)),
                            r && (a.loose = !0),
                            (k = void 0),
                            (m = /^\[[ xX]\] /.test(o)) && ((k = " " !== o[1]), (o = o.replace(/^\[[ xX]\] +/, ""))),
                    ...
                    (e = e.substring(s[0].length)), s[3] && (s[3] = s[3].substring(1, s[3].length - 1)), (g = s[1].toLowerCase().replace(/\s+/g, " ")), this.tokens.links[g] || (this.tokens.links[g] = { href: s[2], title: s[3] });
                else if (
                    ...
                    this.tokens.push(o);
                } else if ((s = this.rules.lheading.exec(e))) (e = e.substring(s[0].length)), this.tokens.push({ type: "heading", depth: "=" === s[2].charAt(0) ? 1 : 2, text: s[1] });
    ...
    function p(e, t) {
        if (((this.options = t || k.defaults), (this.links = e), (this.rules = n.normal), (this.renderer = this.options.renderer || new r()), (this.renderer.options = this.options), !this.links))
    ...
    (n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~"),
            ...
            for (var t, n, r, s, i, l, o = ""; e; )
                if ((i = this.rules.escape.exec(e))) (e = e.substring(i[0].length)), (o += _(i[1]));
                    ...
                    (e = e.substring(i[0].length)),
                        (this.inLink = !0),
                        (r = i[2]),
                        (s = this.options.pedantic ? ((t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? ((r = t[1]), t[3]) : "") : i[3] ? i[3].slice(1, -1) : ""),
        ...
        (p.prototype.mangle = function (e) {
            ...
            for (var t, n = "", r = e.length, s = 0; s < r; s++) (t = e.charCodeAt(s)), 0.5 < Math.random() && (t = "x" + t.toString(16)), (n += "&#" + t + ";");
            return n;
        }),
        ...
        (r.prototype.table = function (e, t) {
            return t && (t = "<tbody>" + t + "</tbody>"), '<table class="table table-striped">\n<thead>\n' + e + "</thead>\n" + t + "</table>\n";
        }),
