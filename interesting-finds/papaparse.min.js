    ...
    (function (e, t) {
                    ...
                    if (Array.isArray(e)) {
                        ...
                        return (
                            ...
                            Array.isArray(e.data) &&
                                ...
                                e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : a(e.data[0])),
        ...
        function l(e) {
            (this._handle = null),
                ...
                (this.parseChunk = function (e, t) {
                    ...
                    if (!this._handle.paused() && !this._handle.aborted()) {
                        ...
                        return (
                            ...
                            this._completed || !a || !z(this._config.complete) || (n && n.meta.aborted) || (this._config.complete(this._completeResults, this._input), (this._completed = !0)),
                ...
                (this._sendError = function (e) {
                    z(this._config.error) ? this._config.error(e) : o && this._config.error && f.postMessage({ workerId: k.WORKER_ID, error: e, finished: !1 });
                });
        }
        function c(e) {
            var i;
        ...
        function r(g) {
                    ...
                    (function () {
                        ...
                        for (var e = 0; e < d.data.length; e++) {
                            ...
                            (d.data[e] = r),
                                g.header &&
                                    (t > f.length
                                        ? y("FieldMismatch", "TooManyFields", "Too many fields: expected " + f.length + " fields but parsed " + t, s + e)
                                        : t < f.length && y("FieldMismatch", "TooFewFields", "Too few fields: expected " + f.length + " fields but parsed " + t, s + e));
                        }
            ...
            (this.parse = function (e, t, r) {
                ...
                if (
                    ...
                    z(g.delimiter) && ((g.delimiter = g.delimiter(e)), (d.meta.delimiter = g.delimiter));
                else {
        ...
        function v(e) {
            ...
            (this.parse = function (i, t, r) {
                ...
                function C(e) {
                    return { data: h, errors: u, meta: { delimiter: O, linebreak: x, aborted: F, truncated: !!e, cursor: d + (t || 0) } };
                }
                function R() {
                    I(C()), (h = []), (u = []);
                }
